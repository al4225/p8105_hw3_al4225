...
**Steps** First, I make the boxplot. Second, I show the outliers. Third,
I add some labs and make it a 2-panel plot.
...
away than 1.5(IQR) are marked separately as outliers the box. In other
words, any point further away than the line in the middle is an outlier.
According to the boxplot, the points are not further away from the
“whisker” so we can think that there are no outliers.
...
<img src="p8105_hw3_al4225_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />
